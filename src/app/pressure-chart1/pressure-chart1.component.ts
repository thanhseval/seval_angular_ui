...
@Component({
  selector: 'app-pressure-chart1',
  templateUrl: './pressure-chart1.component.html',
  styleUrls: ['./pressure-chart1.component.css']
})
export class PressureChart1Component implements OnInit {
