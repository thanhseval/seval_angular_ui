...
@Component({
  selector: 'app-controll-iot1',
  templateUrl: './controll-iot1.component.html',
  styleUrls: ['./controll-iot1.component.css']
})
export class ControllIot1Component {
  ...
  control(action: string) {
    this.deviceService.sendDataDevice003(action).subscribe(
      (res) => {
        console.log(res);
      },
      (err) => {
  ...
  getLatestData() {
    this.getData('PI_1,AI_1_420,AI_2_420,AI_3_420,Bat').subscribe(
      (data) => {
        // console.log(data);
